...
## Vulnerabilities
### GCVE-105-2026-006
If the private key of a client is compromised, a SecureChannel in sign mode can be hijacked with a renew request.  
...
### Threats
- [**Impact**] An attacker could hijack a SecureChannel by renewing it with a compromised private key and use the SecureChannel to send its own requests.
- [**Precondition**] The attacker must have access to the private key of a client with access to the target server and the SecureChannel is in sign mode.
...
[Advisory Source](https://github.com/OPCFoundation/SecurityAdvisories/tree/latest/csaf/2026/006)  
